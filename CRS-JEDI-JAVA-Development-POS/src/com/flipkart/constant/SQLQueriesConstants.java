...
public class SQLQueriesConstants {
    ...
    public static final String ADD_USER_QUERY = "insert into User(userid, name, role, password, gender, address) values (?, ?, ?, ?, ?, ?)";
    ...
    public static final String ADD_STUDENT="insert into student (studentId,branchName,batch,loginApproved,gradeCardApproved,regApproved) values (?,?,?,?,?,?)";
    ...
    public static final String GET_ENROLLED_STUDENTS="select course.courseCode,course.courseName,semesterRegistration.studentId from course inner join semesterRegistration on course.courseCode = semesterRegistration.courseCode where course.profId = ? order by course.courseCode";
